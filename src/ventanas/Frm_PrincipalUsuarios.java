 ...
 * @author RojeruSan
 */
public class Frm_PrincipalUsuarios extends javax.swing.JFrame {

    int x, y;
    public static String user = Frm_login.user;
    String[] opciones = {"Si","No"};
    /**
     * Creates new form Principal
     */

    public Frm_PrincipalUsuarios() {
        initComponents();
        ...
        lbl_usuario.setText(user.toUpperCase());
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_menu_40px_1.png"))); // NOI18N
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 3, 40, 40));
        ...
        jPanel2.add(lbl_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 3, 300, 40));

        minimizeBtn.setBackground(new java.awt.Color(38, 86, 186));
        ...
        minimizeBtn.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lbl_minimize.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        ...
        minimizeBtn.add(lbl_minimize, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -6, 40, 40));

        jPanel2.add(minimizeBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 1, 40, 43));

        exitBtn.setBackground(new java.awt.Color(38, 86, 186));
        ...
        jPanel2.add(exitBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 1, 40, 45));
        ...
        lbl_deco.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbl_deco.setForeground(new java.awt.Color(128, 128, 131));
        lbl_deco.setText("-------------------------------------------------------------------------------------------------");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbl_deco, javax.swing.GroupLayout.PREFERRED_SIZE, 685, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbl_deco, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void tresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tresActionPerformed
        new CambiaPanel(pnlPrincipal, new paneles.pnlVerPedidos());
    ...
    private void dosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dosActionPerformed
        new CambiaPanel(pnlPrincipal, new paneles.pnlHacerPedido());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (posicion > -1) {
            Animacion.Animacion.mover_izquierda(0, -264, 4, 4, pnlMenu);
            Animacion.Animacion.mover_izquierda(263, 130, 4, 4, pnlCentro);
        } else {
            Animacion.Animacion.mover_derecha(-264, 0, 4, 4, pnlMenu);
            Animacion.Animacion.mover_derecha(130, 263, 4, 4, pnlCentro);
        }       
    ...
    private void ochoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ochoActionPerformed
        ...
        int opcion = JOptionPane.showOptionDialog(this, "¿Desea cerrar sesión?", "Cerrar Sesión", JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE, null, opciones, opciones[0]);
    ...
    private void seisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seisActionPerformed
        new CambiaPanel(pnlPrincipal, new paneles.pnlCuenta());
    ...
    private void cincoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cincoActionPerformed
        new CambiaPanel(pnlPrincipal, new paneles.pnlReclamos());
    ...
    private void cuatroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cuatroActionPerformed
        new CambiaPanel(pnlPrincipal, new paneles.pnlInformacion());
    ...
    private void lbl_minimizeMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_minimizeMouseEntered
        minimizeBtn.setBackground(new Color(45, 110, 186));
    ...
    private void lbl_minimizeMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_minimizeMouseExited
        minimizeBtn.setBackground(new Color(38, 86, 186));
        lbl_minimize.setForeground(Color.white);
    }//GEN-LAST:event_lbl_minimizeMouseExited

    private void lbl_exitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_exitMouseClicked
        int opcion = JOptionPane.showOptionDialog(this, "¿Cerrar sesión y salir?", "Salir", JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE, null, opciones, opciones[0]);
    ...
    private void lbl_exitMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_exitMouseEntered
        exitBtn.setBackground(new Color(45, 110, 186));
    ...
    private void lbl_exitMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_exitMouseExited
        exitBtn.setBackground(new Color(38, 86, 186));
        lbl_exit.setForeground(Color.white);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_PrincipalUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    new Frm_PrincipalUsuarios().setVisible(true);
                } catch (ClassNotFoundException | InstantiationException | IllegalAccessException | UnsupportedLookAndFeelException ex) {
                    Logger.getLogger(Frm_PrincipalUsuarios.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
